...
public class LoginActivity_normal extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
                ...
                if(result != null) {
                    try {
                        ...
                        if(resultObject.getInt("result") == 0){
                            ...
                            Toast.makeText(LoginActivity_normal.this, message, Toast.LENGTH_LONG).show();
                        } else {
